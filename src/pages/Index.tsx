    ...
    <main className="bg-background min-h-screen">
      ...
      <section className="editorial-section pt-32 md:pt-44 pb-12 md:pb-20">
        <div className="editorial-container">
          ...
          <p className="text-sm text-muted-foreground mb-1">By Miki Ammann</p>
          <p className="text-sm text-muted-foreground mb-10">Seattle, WA</p>
      ...
      <section className="editorial-section border-t border-border reveal">
        <div className="editorial-container">
          <span className="editorial-label">06 — Interface</span>
          <h2 className="editorial-subhead mb-6">Designing the Interface</h2>
          <p className="editorial-body mb-12">
      ...
      <section className="editorial-section border-t border-border reveal">
        <div className="editorial-container">
          <span className="editorial-label">09 — Reflection</span>
